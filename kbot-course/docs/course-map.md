...
| 09 | 有限步 ReAct | Function Calling、Tool 回喂和最大步数控制 | `internal/runtime/engine/react.go` | `go test ./internal/runtime/engine` |
...
| 11 | 混合检索 | BM25、向量召回和 RRF 排名融合 | `internal/runtime/retriever` | `go test ./internal/runtime/retriever ./internal/runtime/tooling` |
| 12 | Prompt 与 Model Profile | 不可变 Prompt/模型版本和运行快照引用 | `internal/platform/prompt`、`internal/platform/modelconfig` | `go test ./internal/platform/prompt ./internal/platform/modelconfig ./internal/runtime/...` |
| 13 | SKILL.md | Skill 解析、渐进式披露和最小权限 | `internal/platform/skill`、`internal/runtime/skillrunner` | `go test ./internal/platform/skill ./internal/runtime/skillrunner ./internal/runtime/engine` |
...
| 16 | Approval Checkpoint | 敏感 Tool 执行前暂停并保存固定调用 | `internal/platform/approval`、`internal/runtime/engine` | `go test ./internal/platform/approval ./internal/runtime/engine` |
| 17 | A2UI 与恢复执行 | 审批卡片、批准动作和一次性续跑 | `internal/a2ui`、`internal/runtime/engine/approval_worker.go` | `go test ./internal/a2ui ./internal/platform/approval ./internal/runtime/engine ./internal/api` |
...
| 21 | Team 与开放协议 | Team 固定成员版本，接入 MCP、A2A、Webhook 和飞书 | `internal/runtime/team`、`internal/runtime/tooling`、`internal/integration` | `go test ./internal/runtime/team ./internal/platform/team ./internal/runtime/tooling ./internal/integration/...` |
